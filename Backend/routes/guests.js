...
import { validateAddGuest } from "../middleware/verifyGuestDetails.js";
...
router
  ...
  router
    ...
    .patch(verifyUserIdMatchAuthId, verifyParamId('eventId'), verifyParamId('guestId'), handlePatchGuest)
