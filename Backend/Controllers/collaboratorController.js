  ...
  import { addCollaborator } from "../services/collaboratorsLogic";
  ...
  export const handleAddCollaborator = async (req, res) => {
    try {
      ...
      const newCollaborator = await addCollaborator(userId, eventId, collaboratorData);
      return res
        .status(201)
        .json({ successfull: `new collaborator: ${newCollaborator.email} added!` });
    } catch (err) {
