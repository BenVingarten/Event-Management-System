import { getAllUsers, getUserById, patchUser, deleteUser } from '../services/UserLogic.js';
...
export const handleDeleteUser = async (req, res) => {
    try {
        ...
        return res.status(200).json({deleted: `${deletedUser.username} deleted successfully`});
    } catch (err) {
        return res.status(err.statusCode).json({err: err.message});
    }
}
